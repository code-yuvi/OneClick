        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            <View>
                <View style={{ position: 'relative' }}>
                    ...
                    onPress={() => {
                        navigation.navigate('UpdateProfilePhoto', {data: userData});
                    }}>
                    ...
                    <View style={styles.infoMain}>
                        <View style={styles.infoCont}>
                            ...
                            <View style={styles.infoText}>
                                ...
                                <Text style={styles.infoLarge_Text}>{userData.lastName}</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={styles.infoMain}>
                        <View style={styles.infoCont}>
                            ...
                            <View style={styles.infoText}>
                                ...
                                <Text style={styles.infoLarge_Text}>Photo</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={styles.infoMain}>
                        <View style={styles.infoCont}>
                            ...
                            <View style={styles.infoText}>
                                ...
                                <Text style={styles.infoLarge_Text}>{userData.contact}</Text>
                            </View>
                        </View>
                    </View>
                </View>
