...
const UserUI = (props) => {
    ...
    async function getData() {
        ...
        console.log(token);
        axios
            .post('http://192.168.1.36:3000/userdata', { token: token })
            .then(res => {
            ...
            <View>
                <View style={{ position: 'relative' }}>
                    <TouchableOpacity
                        ...
                        <Mobile name="menu" size={30} color="blue" />
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.editIcon}
                        onPress={() => {
                            navigation.navigate('UpdateProfile', { data: usersData });
                        }}>
                ...
                <View style={{ marginTop: 20, marginHorizontal: 25 }}>
                    ...
                    <View style={styles.infoMain}>
                        <View style={styles.infoCont}>
                            ...
                            <View style={styles.infoText}>
                                <Text style={styles.infoSmall_Text}>Last Name</Text>
                                <Text style={styles.infoLarge_Text}>{usersData.lastName}</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={styles.infoMain}>
                        <View style={styles.infoCont}>
                            ...
                            <View style={styles.infoText}>
                                ...
                                <Text style={styles.infoLarge_Text}>User</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={styles.infoMain}>
                        <View style={styles.infoCont}>
                            ...
                            <View style={styles.infoText}>
                                ...
                                <Text style={styles.infoLarge_Text}>{usersData.contact}</Text>
                            </View>
                        </View>
                    </View>
                </View>
